# Intelligent-Drone-Inventory
An autonomous drone-based inventory verification system using Python and Computer Vision to automate real-time stock tracking with zero-latency video processing.
